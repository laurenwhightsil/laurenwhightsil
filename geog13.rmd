...
- I mapped the migration of the weighted mean coordinate location of COVID-19 cases through time, scaling the mean center points with nationwide cumulative cases in relation to the current case counts.
